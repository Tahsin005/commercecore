...
export const en: TranslationType = {
  ...
  home: {
    ...
    featureCodDesc: "Pay after inspecting product",
    featureReturnTitle: "Easy Return Policy",
    featureReturnDesc: "Hassle-free 7-day returns",
    featureDeliveryTitle: "Nationwide Delivery",
    featureDeliveryDesc: "Fast & reliable shipping",
    featureSupportTitle: "24/7 Customer Support",
    featureSupportDesc: "We're always here for you",
