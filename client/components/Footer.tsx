    ...
    <footer className="bg-maroon-900 text-white border-t border-maroon-800 font-sans mt-auto">
      <div className="border-b border-maroon-800/80 bg-maroon-950/60 py-6">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-3 gap-6 text-center md:text-left">
          <div className="flex items-center justify-center md:justify-start space-x-3">
            <div className="p-2.5 bg-maroon-800/80 border border-maroon-700 rounded-lg text-cream shrink-0">
            ...
            <div>
              ...
              <p className="text-[11px] text-maroon-200">Inside Dhaka ৳60 &bull; Outside Dhaka ৳120</p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center md:justify-start space-x-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-maroon-200">Pay safely when you receive your package</p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center md:justify-start space-x-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-maroon-200">Curated premium fabrics &amp; products</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10 grid grid-cols-1 md:grid-cols-12 gap-8">
        <div className="md:col-span-5 space-y-4">
          ...
          <p className="text-xs text-maroon-200 leading-relaxed max-w-sm">
        ...
        <div className="md:col-span-3 space-y-3">
          ...
          <ul className="space-y-2 text-xs text-maroon-200">
            <li>
        ...
        <div className="md:col-span-4 space-y-3">
          ...
          <p className="text-xs text-maroon-200 leading-relaxed">
            Need help with your order? Our support team ensures quick dispatch and real-time order receipts upon checkout.
          </p>
          <div className="pt-1">
            <span className="inline-block text-[11px] font-semibold text-cream bg-maroon-800 border border-maroon-700 px-3 py-1 rounded-md">
      ...
      <div className="border-t border-maroon-800/80 bg-maroon-950 py-4 text-center text-xs text-maroon-300">
        <div className="max-w-6xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p>&copy; {new Date().getFullYear()} CommerceCore. All rights reserved.</p>
          <p className="flex items-center space-x-1 text-[11px] text-maroon-400">
